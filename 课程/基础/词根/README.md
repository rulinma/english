...
* re
  * 再次、回
    * recycle（回收利用）、 replace（替换）

* reg
  * 统治、支配
    * regulate（调整、控制）、 region（地区、区域）

* sa
  * 同性质、相同
    * same（相同的）、 sample（样本、样品）
...
* sed
  * 坐
    * sedentary（久坐的）、 sedative（镇静剂）

* sem
  * 一半、部分
    * semi-final（半决赛）、 semester（学期）

* sen
  * 老年的、年老的
    * senior（年长的）、 senile（老年的）

* ser
  * 连接、序列
    * series（系列、连续剧）、 serenade（小夜曲）

* sol
  * 太阳
    * solar（太阳的）、 solstice（至日）

* sta
  * 站立、放置
    * stand（站立）、 establish（建立）

* ster
  * 产生、使得
    * monster（怪物）、 master（主人、大师）
...
* tem
  * 时间
    * temporary（暂时的）、 contemporary（同时代的）

* ten
  * 拉、紧
    * tension（紧张）、 tendon（肌腱）
