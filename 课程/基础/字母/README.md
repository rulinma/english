...
* [M-m](M.md)
  ...
  * 手，跟汉字“爪”非常相似
    ...
    * maker（制造者；造物主）
* [N-n](N.md)
  * 埃及符号是字母“N”，它最初看起来像是在代表眼镜蛇或蛇的较大波纹之上的一个小波纹。古闪米特人赋予它音n，象征“鱼”。也有从象形看是鼻子（2个竖线和上面1个横线，类似脸上连在一起的2个鼻孔），也有门形的说法。
  * 鼻子
    * nose（鼻子）
...
* [P-p](P.md)
  * 在古代闪米特语中，今天的字母“P”看起来像一个倒置的“V”。它发音为“pe”，意思是“嘴巴”。腓尼基人将它的顶部变成了斜钩形。公元前200年，罗马人将它向右翻转并闭合环以形成“P”。
  * 站着的人
    * people（人）
    * public（公共的）
  * 嘴
  ...
  * 普通话发音平
    * plain（平原）
* [Q-q](Q.md)
  * 最初表示猴子的尾巴，被写成一个垂直线穿过的圆圈，后来改写成今天这个形式。疑问的意思我想象嘴巴里的舌头在说话，表示疑问，也有方形的说法，就是Q象形正方形口。
  * 疑问
    * question（疑问）
    * query（询问）
  * 方形
...
* [R-r](R.md)
  * 人面朝左的轮廓是闪米特人书写的字母“R”的原始形状，意思是“头”，罗马人将它向右转，并添加了一个倾斜的脚。也有说法上面是太阳的意义，从而衍生出光，发散等意义。
  ...
  * 中文的日读音类似，都表示太阳
* [S-s](S.md)
  * 字母“S”曾经看起来像一个水平的波浪形W，用来代表弓箭手的弓，罗马人将其翻转到垂直位置。也有埃及的蛇形象形说。
  * 蛇形（埃及语系）
    * snake（蛇）
  * 光滑
    * smooth（光滑）
...
* [T-t](T.md)
  * 古代闪米特人使用我们今天看到的字母“T”的小写形式。腓尼基人称这个字母为标记。希腊人在字母的顶部添加了十字，以区别于字母“X”。
  * 神
    * throne（权杖，王位）
    * theology（神学）
  * T形，标记
...
* [V-v](V.md)
  ...
  * V字形
    ...
    * velocity（速度）
* [W-w](W.md)
  * 字母“W”起源于中世纪，查理曼大帝的抄写员并排写下了两个“u”，中间用一个空格隔开。当时发出的声音类似于“v”。这封信在1700年作为一个独特的字母“W”出现在印刷品中。也有水波纹的象形，从而产生波纹，曲折，疑问等衍生意义。
  * 水
    * water（水）
    * wave（波）
    * wash（洗）
...
* [X-x](X.md)
  ...
  * 分叉
    * exit（退出，出口）
* [Y-y](Y.md)
  * 字母Y是在公元100年由罗马人添加的，象形并产生分叉、幼苗等意义。
  * 分叉
    * yoke（牛轭）
    * by（旁）
    * bypass（绕路）
  ...
  * 幼苗状
    ...
    * yield（出产）
* [Z-z](Z.md)
  * 腓尼基人意思是“斧头”，基本没有使用，后来希腊和法语系修改为Z并使用，主要使用还是Z象形及其衍生意义。
  * 神秘
    * Zeus（宙斯，希腊的万神之王）
    * maze（迷宫）
    * amaze（惊奇）
