...
* [O-o](O.md)
  ...
  * 与字母C表达的洞穴不同，字母O表达的多是与“口”有关的意思。例如，口述的(oral)、歌剧(opera)、服从(obey)等。从形状上看，字母O与字母C有些相似，但又有点区别。从两组单词中也许可以找到C和O的区别，例如，小圈(circle)和轨迹(orbit)、(卷心菜) cabbage 和洋葱(onion)。含有字母C的单词circle，无论是用来表达马戏团的“火圈”还是《西游记》中孙悟空给唐僧画的“保护圈”，像字母C一样似乎有个“出口”;含有字母O的orbit，则通常用来表示星球的运行轨迹，像字母O一样没有“出口”。另外，cabbage（卷心菜）和onion（洋葱，洋葱头）的叶片，一个是有“开口”的，一个是“闭合”的，跟字母C和O也是非常契合。
* [P-p](P.md)
