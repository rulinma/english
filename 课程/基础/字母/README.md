...
* 文字语言是人类文明的综合创造，多文化，多种族的智慧融合（英语也必然如此）。
* 大写字母主要来自于象形及其衍生意义（人类认识事物的一般特征）。
* 英文字母起源拉丁文字，最初有21个字母，引入了希腊字母Y和Z，从I分离出J，从U分化出V，两个V变成W（传闻也无需考证）。
* 小写字母主要是为了书写方便（首先有大写字母，后才有小写字母）。
* 音行义的融汇贯通是学习语言的基础和核心（音也是重要因素）。
