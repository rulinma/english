...
* C-c
  * 一种说法是山洞的象形，是人类最初居住的地方，用来遮风避雨，抵御酷暑严寒。对于古代的人们来说，天然的山洞自然就成了最佳的栖息之地。从山洞衍生出房子，居住地，文明等意义。也有一种说法是骆驼的驼峰象形。C的象形也有镰刀，弯曲，切割，破碎，分类，农业，圆，口等意义。
* D-d
...
* E-e
  * E的一种说法是象举起双手的人，衍生出祈祷的意义；E字母上下相等，衍生公平、公正、相等的意义；也有象眼睛和窗户的说法，眼睛看到的就有存在的衍生意义；另外小写的e类似椭圆也有其衍生意义。
* F-f
  * 原始的腓尼基符号F更像Y，古希腊修改为类似现在的F，罗马人再修改为F。从F看就有权杖（表神权和生命），武器，飞鸟（表飞），流动，羽毛，分叉等基础含义。
* G-g
  * D是大地上长出东西的象形，并衍生出萌发，新生，伟大等其他意义；也有说法是C的变形，表示带门的房子，也有区分[g]和[k]的发音的说法。
* H-h
